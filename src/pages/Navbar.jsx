...
function Navbar() {
    ...
    const socialLinks = [
        ...
        {
            name: "Instagram",
            href: "https://www.instagram.com/ashxglobalnetwork?igsh=MTVkanRuMjZmbTd3OA==",
            icon: (
                <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        {
            name: "Threads",
            href: "https://www.threads.com/@ashxglobalnetwork",
            icon: (
                <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        {
            name: "YouTube",
            href: "https://www.youtube.com/@ashxglobalnetwork?si=XF5ouA_7T6hAyvLS",
            icon: (
                <svg viewBox="0 0 24 24" aria-hidden="true">
                    <path fill="currentColor" d="M23.5 7.2a3.1 3.1 0 0 0-2.18-2.2C19.4 4.5 12 4.5 12 4.5s-7.4 0-9.32.5A3.1 3.1 0 0 0 .5 7.2 32.4 32.4 0 0 0 0 12a32.4 32.4 0 0 0 .5 4.8 3.1 3.1 0 0 0 2.18 2.2c1.92.5 9.32.5 9.32.5s7.4 0 9.32-.5a3.1 3.1 0 0 0 2.18-2.2A32.4 32.4 0 0 0 24 12a32.4 32.4 0 0 0-.5-4.8zM9.75 15.48V8.52L15.98 12l-6.23 3.48z" />
                </svg>
            ),
        },
        {
            name: "Facebook",
            href: "https://www.facebook.com/share/1BhVd49vvd/",
            icon: (
                <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        {
            name: "LinkedIn",
            href: "https://www.linkedin.com/company/ashx-global-network/",
            icon: (
                <svg viewBox="0 0 24 24" aria-hidden="true">
